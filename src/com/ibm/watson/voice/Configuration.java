	...
	public static Configuration getInstance() {
		if(instance == null) {
			...
			if(CONVERSATION_WORKSPACE_STRING == null) {
				instance.CONVERSATION_WORKSPACE_ID = CommonUtils.getPropertyValue("ibm.watson.conv.wsid");
			} else {
			...
			if(vcapConfig == null) {
				...
				instance.CONVERSATION_USERNAME = CommonUtils.getPropertyValue("ibm.watson.conv.user");
				instance.CONVERSATION_PASSWORD = CommonUtils.getPropertyValue("ibm.watson.conv.pass");

				instance.SPEECH_TO_TEXT_USERNAME = CommonUtils.getPropertyValue("ibm.watson.stt.user");
				instance.SPEECH_TO_TEXT_PASSWORD = CommonUtils.getPropertyValue("ibm.watson.stt.pass");

				instance.TEXT_TO_SPEECH_USERNAME = CommonUtils.getPropertyValue("ibm.watson.tts.user");
				instance.TEXT_TO_SPEECH_PASSWORD = CommonUtils.getPropertyValue("ibm.watson.tts.pass");
